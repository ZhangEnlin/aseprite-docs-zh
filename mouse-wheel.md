...
默认的鼠标滚轮行为取决于 [*编辑 > 首选项 > 编辑器 > 使用滚轮缩放*](./preferences.md#editor) 选项。此行为的部分将在不久的将来发生变化：[Issue #2896](https://github.com/aseprite/aseprite/issues/2896) 。

作为参考且仅在本节中，以下符号具有给定的含义：
...
通过 *编辑 > 键盘快捷键 > 鼠标滚轮* ，可以配置当按下某些额外按键时的鼠标滚轮行为：

![键盘快捷键中的鼠标滚轮](./keyboard-shortcuts/mouse-wheel-custom.png)
