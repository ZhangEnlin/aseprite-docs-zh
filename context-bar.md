...
上下文栏显示当前活动工具的具体选项。它也会根据活动文档的状态而变化（例如，当移动选区时）。可以在[精灵编辑器](./sprite-editor.md)视图的正上方找到上下文栏：
...
画笔大小（以像素为单位）。要快速更改画笔大小，可以使用 <kbd>Ctrl + Alt</kbd> 并拖动。
...
在透明色选项中，可以更改选区中的透明色是不透明还是透明。上图显示的是透明模式。
